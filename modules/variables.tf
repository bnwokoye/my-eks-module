...
variable "dns_hostnames" {
   type = string
   description = "This is a variable for vpc support"
...
variable "vpc_tags" {
  type = map(string)
  description = "This is a variable for your vpc tags"
  default = {
    Name        = "main_vpc"
...
variable "igw_tags" {
  type = map(string)
  description = "This is a variable for internet gateway tags"
  default = {
    Name        = "vpc_igw"
    Environment = "Production"
    Team        = "DevOps"
